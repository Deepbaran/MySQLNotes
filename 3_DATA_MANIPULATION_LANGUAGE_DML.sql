...
-- SQL for inserting data into tables
/*
insert into <table_name> (<column1>,<column2>,<column3>,...)
values ('value1','value2','value3',...);
*/

insert into products (name,price,coffee_origin) -- as the id column is auto_increment so, no need to insert here
values ('Espresso',2.50,'Brazil');

insert into products (name,price,coffee_origin)
values ('Macchiato',3.00,'Brazil'),('Cappuccino',3.50,'Costa Rica'); -- Added two rows of data. Adding multiple rows of data

insert into products (name,price,coffee_origin) -- as the id column is auto_incrementing so, no need to insert here
values ('Late',3.50,'Indonesia'),('Americano',3.00,'Brazil'),
...
*/
-- By default in MySQL, we are only allowed to use the id column (Primary Key Column) in the where statement here. This is due to safe updates.
-- To deactivate we need to ru this SQL: set sql_safe_updates=0; -- 0 means deactivate and 1 means activate
...
-- update single column of multiple rows
update products
...
('Thomas',27,'M'),('Chris',44,'M'),
('Sally',23,'F'),('Frank',55,'M');

-- SQL for deleting data from the table
/*
